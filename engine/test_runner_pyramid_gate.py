...
class TestPyramidGatedByMacroBlock(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # OFF makes engine/runner.py's new 2b.5 block a complete no-op so the
        # seeded US.TEST position below doesn't pick up an unrelated side
        # effect (real confidence_score/regime_store I/O, real
        # position_manager_state.json/position_manager_log.jsonl writes).
