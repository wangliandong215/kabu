...
BEAT_TYPE_MAP = {
    "EPS": moomoo.BeatType.EPS,
    "REVENUE": moomoo.BeatType.REVENUE,
    "EBIT": moomoo.BeatType.EBIT,
}

TERM_MAP = {
    "LATEST": moomoo.BeatTerm.LATEST,
    "LATEST_QUARTER": moomoo.BeatTerm.LATEST_QUARTER,
    "LATEST_HALF": moomoo.BeatTerm.LATEST_HALF,
    "LATEST_ANNUAL": moomoo.BeatTerm.LATEST_ANNUAL,
    "ALL": moomoo.BeatTerm.ALL,
}

SORT_FIELD_MAP = {
    "BEAT_RATIO": moomoo.EarningsBeatSortField.BEAT_RATIO,
    "EARNING_DAY_CHG": moomoo.EarningsBeatSortField.EARNING_DAY_CHG,
    "RELEASED_DATE": moomoo.EarningsBeatSortField.RELEASED_DATE,
    "ACTUAL": moomoo.EarningsBeatSortField.ACTUAL,
    "ESTIMATE": moomoo.EarningsBeatSortField.ESTIMATE,
    "YOY": moomoo.EarningsBeatSortField.YOY,
    "YOY_GROWTH": moomoo.EarningsBeatSortField.YOY_GROWTH,
    "PE_TTM": moomoo.EarningsBeatSortField.PE_TTM,
    "DIVIDENDS_TTM": moomoo.EarningsBeatSortField.DIVIDENDS_TTM,
    "PRICE": moomoo.EarningsBeatSortField.PRICE,
    "CHANGE_RATE": moomoo.EarningsBeatSortField.CHANGE_RATE,
}


def _build_filters(config_path):
    from moomoo import EarningsBeatRankFilter, EarningsBeatIndicatorType
