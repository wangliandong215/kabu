...
REGION_MAP = {
    "HK": moomoo.MacroRegion.HK,
    "US": moomoo.MacroRegion.US,
    "JP": moomoo.MacroRegion.JP,
    "SG": moomoo.MacroRegion.SG,
    "AU": moomoo.MacroRegion.AU,
    "CA": moomoo.MacroRegion.CA,
    "MY": moomoo.MacroRegion.MY,
    "CN": moomoo.MacroRegion.CN,
}
