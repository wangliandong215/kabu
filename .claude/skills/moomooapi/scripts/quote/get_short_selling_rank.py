...
SORT_FIELD_MAP = {
    "SHORT_NUMBER_CHANGE": moomoo.ShortSellingSortField.SHORT_NUMBER_CHANGE,
    "SHORT_RATIO_CHANGE": moomoo.ShortSellingSortField.SHORT_RATIO_CHANGE,
    "SHORT_NUMBER": moomoo.ShortSellingSortField.SHORT_NUMBER,
    "SHORT_RATIO": moomoo.ShortSellingSortField.SHORT_RATIO,
    "VOLUME": moomoo.ShortSellingSortField.VOLUME,
    "POSITION_VOLUME": moomoo.ShortSellingSortField.POSITION_VOLUME,
    "POSITION_RATIO": moomoo.ShortSellingSortField.POSITION_RATIO,
    "DAYS_TO_COVER": moomoo.ShortSellingSortField.DAYS_TO_COVER,
    "WEEK_AVG_VOLUME": moomoo.ShortSellingSortField.WEEK_AVG_VOLUME,
    "WEEK_AVG_SHORT_NUMBER": moomoo.ShortSellingSortField.WEEK_AVG_SHORT_NUMBER,
    "WEEK_AVG_SHORT_RATIO": moomoo.ShortSellingSortField.WEEK_AVG_SHORT_RATIO,
    "MONTH_AVG_VOLUME": moomoo.ShortSellingSortField.MONTH_AVG_VOLUME,
    "MONTH_AVG_SHORT_NUMBER": moomoo.ShortSellingSortField.MONTH_AVG_SHORT_NUMBER,
    "MONTH_AVG_SHORT_RATIO": moomoo.ShortSellingSortField.MONTH_AVG_SHORT_RATIO,
}

SORT_DIR_MAP = {
    0: moomoo.RankSortDir.DESCENDING,
    1: moomoo.RankSortDir.ASCENDING,
}
