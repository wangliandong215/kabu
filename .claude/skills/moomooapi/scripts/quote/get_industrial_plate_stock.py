...
SORT_FIELD_MAP = {
    "CODE": moomoo.PlateStockSortField.CODE,
    "CHANGE_RATE": moomoo.PlateStockSortField.CHANGE_RATE,
    "TURNOVER": moomoo.PlateStockSortField.TURNOVER,
    "VOLUME": moomoo.PlateStockSortField.VOLUME,
    "MARKET_VAL": moomoo.PlateStockSortField.MARKET_VAL,
}
