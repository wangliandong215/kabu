...
PERIOD_MAP = {
    "FIVE_MIN": moomoo.RankPeriodType.FIVE_MIN,
    "ONE_DAY": moomoo.RankPeriodType.ONE_DAY,
    "FIVE_DAY": moomoo.RankPeriodType.FIVE_DAY,
    "TWENTY_DAY": moomoo.RankPeriodType.TWENTY_DAY,
    "SIXTY_DAY": moomoo.RankPeriodType.SIXTY_DAY,
    "ONE_TWENTY_DAY": moomoo.RankPeriodType.ONE_TWENTY_DAY,
    "TWO_FIFTY_DAY": moomoo.RankPeriodType.TWO_FIFTY_DAY,
    "YTD": moomoo.RankPeriodType.YTD,
}
...
def _build_filters(config_path):
    from moomoo import PeriodChangeRankFilter, PeriodChangeIndicatorType
