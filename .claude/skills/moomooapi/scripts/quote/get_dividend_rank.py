...
RANK_TYPE_MAP = {
    "HIGH_YIELD": moomoo.DividendRankType.HIGH_YIELD,
    "DIVIDEND_GROWTH": moomoo.DividendRankType.DIVIDEND_GROWTH,
}

SORT_FIELD_MAP = {
    "DIVIDEND_YIELD_TTM": moomoo.DividendRankSortField.DIVIDEND_YIELD_TTM,
    "AVG_DIVIDEND_YIELD_5Y": moomoo.DividendRankSortField.AVG_DIVIDEND_YIELD_5Y,
    "DISTRIBUTION_FREQUENCY": moomoo.DividendRankSortField.DISTRIBUTION_FREQUENCY,
    "DIVIDEND_GROW_YEAR": moomoo.DividendRankSortField.DIVIDEND_GROW_YEAR,
    "DIVIDENDS_TTM": moomoo.DividendRankSortField.DIVIDENDS_TTM,
    "PAYOUT_RATIO_LFY": moomoo.DividendRankSortField.PAYOUT_RATIO_LFY,
    "PRICE": moomoo.DividendRankSortField.PRICE,
    "MARKET_CAP": moomoo.DividendRankSortField.MARKET_CAP,
    "CHANGE_RATE": moomoo.DividendRankSortField.CHANGE_RATE,
    "CHANGE_AMOUNT": moomoo.DividendRankSortField.CHANGE_AMOUNT,
}


def _build_filters(config_path):
    from moomoo import DividendRankFilter, DividendRankIndicatorType, DistributionFrequency
