...
SORT_FIELD_MAP = {
    "MARKET_CAP": moomoo.HighDividendSOESortField.MARKET_CAP,
    "DIVIDEND_YIELD_TTM": moomoo.HighDividendSOESortField.DIVIDEND_YIELD_TTM,
    "PB": moomoo.HighDividendSOESortField.PB,
    "PE_TTM": moomoo.HighDividendSOESortField.PE_TTM,
    "PRICE": moomoo.HighDividendSOESortField.PRICE,
    "CHANGE_RATIO": moomoo.HighDividendSOESortField.CHANGE_RATIO,
}
...
def _build_filters(config_path):
    from moomoo import HighDividendSOERankFilter, HighDividendSOEIndicatorType
