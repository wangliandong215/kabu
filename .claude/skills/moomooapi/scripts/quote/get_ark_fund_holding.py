...
HOLDING_TYPE_MAP = {
    "POSITION": moomoo.ArkHoldingType.POSITION,
    "INCREASE": moomoo.ArkHoldingType.INCREASE,
    "DECREASE": moomoo.ArkHoldingType.DECREASE,
    "NEW": moomoo.ArkHoldingType.NEW,
    "SOLD_OUT": moomoo.ArkHoldingType.SOLD_OUT,
}

CYCLE_MAP = {
    "ONE_DAY": moomoo.ArkCycleType.ONE_DAY,
    "FIVE_DAY": moomoo.ArkCycleType.FIVE_DAY,
    "TEN_DAY": moomoo.ArkCycleType.TEN_DAY,
    "THIRTY_DAY": moomoo.ArkCycleType.THIRTY_DAY,
    "SIXTY_DAY": moomoo.ArkCycleType.SIXTY_DAY,
}

SORT_FIELD_MAP = {
    "SHARES": moomoo.ArkFundHoldingSortField.SHARES,
    "WEIGHT_CHANGE": moomoo.ArkFundHoldingSortField.WEIGHT_CHANGE,
    "SHARES_CHANGE": moomoo.ArkFundHoldingSortField.SHARES_CHANGE,
    "MARKET_VALUE": moomoo.ArkFundHoldingSortField.MARKET_VALUE,
    "WEIGHT": moomoo.ArkFundHoldingSortField.WEIGHT,
}
