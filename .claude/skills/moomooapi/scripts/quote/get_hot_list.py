...
SORT_FIELD_MAP = {
    "TRADE_HEAT": moomoo.HotListSortField.TRADE_HEAT,
    "SEARCH_HEAT": moomoo.HotListSortField.SEARCH_HEAT,
    "NEWS_HEAT": moomoo.HotListSortField.NEWS_HEAT,
    "AVERAGE_HEAT": moomoo.HotListSortField.AVERAGE_HEAT,
}
...
def _build_filters(config_path):
    from moomoo import HotListFilter, HotListIndicatorType
