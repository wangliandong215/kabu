...
CHANGE_TYPE_MAP = {
    "NEW": moomoo.InstitutionHoldingChangeType.NEW,
    "SOLD_OUT": moomoo.InstitutionHoldingChangeType.SOLD_OUT,
    "INCREASE": moomoo.InstitutionHoldingChangeType.INCREASE,
    "DECREASE": moomoo.InstitutionHoldingChangeType.DECREASE,
}

SORT_FIELD_MAP = {
    "HOLDING_VALUE": moomoo.InstitutionHoldingListSortField.HOLDING_VALUE,
    "HOLDING_PCT": moomoo.InstitutionHoldingListSortField.HOLDING_PCT,
    "LAST_HOLDING_PCT": moomoo.InstitutionHoldingListSortField.LAST_HOLDING_PCT,
    "CHANGE_SHARES": moomoo.InstitutionHoldingListSortField.CHANGE_SHARES,
    "CHANGE_PCT": moomoo.InstitutionHoldingListSortField.CHANGE_PCT,
    "PORTFOLIO_PCT": moomoo.InstitutionHoldingListSortField.PORTFOLIO_PCT,
    "INDUSTRY": moomoo.InstitutionHoldingListSortField.INDUSTRY,
    "HOLDING_DATE": moomoo.InstitutionHoldingListSortField.HOLDING_DATE,
}
