...
SORT_MAP = {
    "HOT": moomoo.EarningsCalendarSortType.HOT,
    "MARKET_CAP": moomoo.EarningsCalendarSortType.MARKET_CAP,
    "OPTION_VOLUME": moomoo.EarningsCalendarSortType.OPTION_VOLUME,
    "IV": moomoo.EarningsCalendarSortType.IV,
    "IV_RANK": moomoo.EarningsCalendarSortType.IV_RANK,
    "IV_PERCENTILE": moomoo.EarningsCalendarSortType.IV_PERCENTILE,
    "RT_MARKET_CAP": moomoo.EarningsCalendarSortType.RT_MARKET_CAP,
}


def _build_filters(config_path):
    from moomoo import EarningsCalendarFilter, EarningsCalendarIndicatorType
        ...
        if "value_list" in s:
            ...
            for v in s["value_list"]:
                for cls_name in ["EarningsCalendarPubType", "EarningsCalendarEstimateType", "EarningsCalendarStockListType"]:
                    cls = getattr(moomoo, cls_name, None)
