...
HOLDING_TYPE_MAP = {
    "INCREASE": moomoo.ArkActiveTransactionHoldingType.INCREASE,
    "DECREASE": moomoo.ArkActiveTransactionHoldingType.DECREASE,
    "NEW": moomoo.ArkActiveTransactionHoldingType.NEW,
    "SOLD_OUT": moomoo.ArkActiveTransactionHoldingType.SOLD_OUT,
}
...
SORT_FIELD_MAP = {
    "CHANGE_AMOUNT": moomoo.ArkActiveTransactionSortField.CHANGE_AMOUNT,
    "CHANGE_SHARES": moomoo.ArkActiveTransactionSortField.CHANGE_SHARES,
}
