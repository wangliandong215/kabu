...
SORT_FIELD_MAP = {
    "CHANGE_PCT": moomoo.InstitutionHoldingChangeSortField.CHANGE_PCT,
    "CHANGE_SHARES": moomoo.InstitutionHoldingChangeSortField.CHANGE_SHARES,
    "HOLDING_DATE": moomoo.InstitutionHoldingChangeSortField.HOLDING_DATE,
}
