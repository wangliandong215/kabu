...
SORT_FIELD_MAP = {
    "CHANGE_RATE": moomoo.HeatMapSortField.CHANGE_RATE,
    "MARKET_VAL": moomoo.HeatMapSortField.MARKET_VAL,
    "TURNOVER": moomoo.HeatMapSortField.TURNOVER,
    "HOT": moomoo.HeatMapSortField.HOT,
}

PLATE_TYPE_MAP = {
    "INDUSTRY": moomoo.HeatMapPlateType.INDUSTRY,
    "CONCEPT": moomoo.HeatMapPlateType.CONCEPT,
    "THEME": moomoo.HeatMapPlateType.THEME,
}
